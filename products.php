...
<html>
	...
	<body>
		...
		?>
		<div class="container panel-margin" style="padding-top: 75px; padding-bottom: 50px;">
			<div class="jumbotron">
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail" style="height=340px; width=350px;">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="3.jpg" alt="camera" style="height=340px; width=350px;">
						<div class="caption">
							<h3>Camera 3</h3>
							<p>Price: <i class="fa fa-rupee"></i> 80,000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="4.jpg" alt="camera" style="height=340px; width=350px;">
						<div class="caption">
							<h3>Camera 4</h3>
							<p>Price: <i class="fa fa-rupee"></i> 80,000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
